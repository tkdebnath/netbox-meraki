# Initial migration for netbox_meraki plugin
# Generated for NetBox 4.4.x
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mx_device_role', models.CharField(default='Meraki Firewall', help_text='Device role for MX (Security Appliance) devices', max_length=100, verbose_name='MX Device Role')),
                ('ms_device_role', models.CharField(default='Meraki Switch', help_text='Device role for MS (Switch) devices', max_length=100, verbose_name='MS Device Role')),
                ('mr_device_role', models.CharField(default='Meraki AP', help_text='Device role for MR (Wireless AP) devices', max_length=100, verbose_name='MR Device Role')),
                ('mg_device_role', models.CharField(default='Meraki Cellular Gateway', help_text='Device role for MG (Cellular Gateway) devices', max_length=100, verbose_name='MG Device Role')),
                ('mv_device_role', models.CharField(default='Meraki Camera', help_text='Device role for MV (Camera) devices', max_length=100, verbose_name='MV Device Role')),
                ('mt_device_role', models.CharField(default='Meraki Sensor', help_text='Device role for MT (Sensor) devices', max_length=100, verbose_name='MT Device Role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_type', models.CharField(choices=[('include', 'Include (whitelist)'), ('exclude', 'Exclude (blacklist)')], default='include', help_text='Whether to include or exclude matching prefixes', max_length=10, verbose_name='Filter Type')),
                ('prefix_pattern', models.CharField(blank=True, help_text='Regular expression pattern to match prefix addresses (e.g., "^10\\..*" for 10.0.0.0/8)', max_length=500, verbose_name='Prefix Pattern')),
                ('prefix_length_filter', models.CharField(blank=True, choices=[('any', 'Any length'), ('exact', 'Exact length'), ('range', 'Length range')], default='any', help_text='Filter by prefix length', max_length=10, verbose_name='Length Filter')),
                ('min_prefix_length', models.IntegerField(blank=True, help_text='Minimum prefix length (for range filter)', null=True, verbose_name='Min Length')),
                ('max_prefix_length', models.IntegerField(blank=True, help_text='Maximum prefix length (for range filter)', null=True, verbose_name='Max Length')),
                ('priority', models.IntegerField(default=100, help_text='Rule priority (lower values are evaluated first)')),
                ('enabled', models.BooleanField(default=True, help_text='Enable or disable this rule')),
                ('description', models.TextField(blank=True, help_text='Optional description of what this rule does')),
            ],
